...
class Build_Recipe_Dialog
{
    ...
    class Controls
    {
        ...
        {
            idc = 1201;
            //text = "\BB_Buildings\code\buildRecipeBook\images\tanktrap.paa"
        ...
        {
            idc = 1202;
            //text = "\BB_Buildings\code\buildRecipeBook\images\wirefencekit.paa";
        ...
        {
            idc = 1203;
            //text = "\BB_Buildings\code\buildRecipeBook\images\sandbag.paa";
        ...
        class LogImage: RscPicture
        {
            ...
            //text = "\BB_Buildings\code\buildRecipeBook\images\wood.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class ScrapImage: RscPicture
        {
            ...
            //text = "\BB_Buildings\code\buildRecipeBook\images\scrapmetal.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class GrenadeImage: RscPicture
        {
            ...
            //text = "\BB_Buildings\code\buildRecipeBook\images\grenade.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class PrevButton: RscButton
        {
            ...
            action = "_nil=[]ExecVM '\BB_Buildings\code\buildRecipeBook\prevBuildRecipe.sqf'";
        };
        ...
        class NextButton: RscButton
        {
            ...
            w = 0.0886457 * safezoneW;
            h = 0.0521932 * safezoneH;
            action = "_nil=[]ExecVM '\BB_Buildings\code\buildRecipeBook\nextBuildRecipe.sqf'";
        };
        class ShowButton: RscButton
        {
            ...
            action = "closeDialog 0;_nil=[]ExecVM '\BB_Buildings\code\building\player_build.sqf'";
        };
        class ShowListButton: RscButton
        {
            ...
            w = 0.0751041 * safezoneW;
            h = 0.051254 * safezoneH;
            action = "closeDialog 0;_nil=[]ExecVM '\BB_Buildings\code\buildRecipeBook\build_recipe_list_dialog.sqf'";
        };
        ...
        class ToolboxImage: RscPicture
        {
            ...
            //text = "\BB_Buildings\code\buildRecipeBook\images\toolbox.paa";
        ...
        {
            idc = 1209;
            text = "\BB_Buildings\code\buildRecipeBook\images\timer.paa";
            x = 0.409766 * safezoneW + safezoneX;
            y = 0.444989 * safezoneH + safezoneY;
            w = 0.019375 * safezoneW;
            h = 0.0315319 * safezoneH;
