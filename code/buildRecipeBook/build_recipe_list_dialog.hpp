...
class Build_Recipe_List_Dialog
{
    ...
    {    
        ...
        class BackButton: RscButton
        {
            ...
            action = "closeDialog 0;_nil=[]ExecVM '\BB_Buildings\code\buildRecipeBook\build_recipe_dialog.sqf'";
        };
        class ViewButton: RscButton
        {
            ...
            w = 0.128906 * safezoneW;
            h = 0.0550106 * safezoneH;
            action = "_nil=[]ExecVM '\BB_Buildings\code\buildRecipeBook\build_recipe_list_select.sqf'";
