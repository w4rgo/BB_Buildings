private ["_validObjectCode","_panelPos","_playerPos","_cnt","_gateAccess","_panel","_convertInput","_code","_inputCode","_validMatch","_validIndividualDoors"];
_panel = cursortarget;
_gateAccess = false;
...
{ 
    case "operateDoor": {
        _validDoor = [_code, (toString _convertInput)] call BIS_fnc_areEqual;
        if (_validDoor) then {
